function makeCommentPost(pid)
{
    ...
    xhttp.open("POST", "./handlers/postcomment.php", true);
...
function makeLikePost(pid)
{
    ...
    xhttp.open("POST", "./handlers/postlike.php", true);
    xhttp.send(JSON.stringify({postid: pid}));
}
...
function makeSharePost(pid)
{
    ...
    xhttp.open("POST", "./handlers/postshare.php", true);
    xhttp.send(JSON.stringify({postid: pid}));
}
...
function loadPostFeed(cc, offset) 
{
    ...
    xhttp.open("POST", "./handlers/feedfetch.php", true);
...
function loadPostsAll(uid, cc, offset) 
{
    ...
    xhttp.open("POST", "./handlers/originalsfetch.php", true);
...
function newPost()
{
    ...
    xhttp.open("POST", "./handlers/newpost.php", true);
